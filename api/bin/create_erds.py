...
from src.db.models.transfer import transfer_topportunity_models
...
ALL_MODULES = [opportunity_models, transfer_topportunity_models]

TRANSFER_TABLE_MODULES = [transfer_topportunity_models]
