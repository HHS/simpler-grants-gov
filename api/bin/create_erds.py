...
from src.db.models.staging import staging_topportunity_models
...
ALL_MODULES = [opportunity_models, staging_topportunity_models]

STAGING_TABLE_MODULES = [staging_topportunity_models]
