...
from tests.src.db.models.factories import OpportunityFactory, OpportunityAssistanceListingFactory, AgencyFactory
...
def test_save_opportunity_version(db_session, enable_factory_create):
    ...
    expected = {
        ...
        'opportunity_assistance_listings': [{'program_title': opp_ass.program_title, 'assistance_listing_number': opp_ass.assistance_listing_number}]}
