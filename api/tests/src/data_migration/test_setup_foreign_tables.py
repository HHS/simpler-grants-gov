...
EXPECTED_LOCAL_OPPORTUNITY_SQL = (
    "CREATE TABLE IF NOT EXISTS {}.topportunity "
    "(opportunity_id NUMERIC(20) NOT NULL CONSTRAINT topportunity_pkey PRIMARY KEY,"
...
EXPECTED_NONLOCAL_OPPORTUNITY_SQL = (
    "CREATE FOREIGN TABLE IF NOT EXISTS {}.topportunity "
...
EXPECTED_LOCAL_TEST_SQL = (
    ...
    "(id INTEGER NOT NULL CONSTRAINT test_table_pkey PRIMARY KEY,"
    "description TEXT)"
)
...
def test_build_sql(table, is_local, expected_sql, test_foreign_schema):
    ...
    assert sql == expected_sql.format(test_foreign_schema)
