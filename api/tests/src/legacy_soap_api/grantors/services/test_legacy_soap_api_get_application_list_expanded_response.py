...
from src.legacy_soap_api.grantors.services.get_application_list_expanded_response import (
    get_application_list_expanded_response,
)
...
class TestLegacySoapApiGrantorGetApplicationListExpanded:
    def test_get_application_list_expanded_response(self, db_session, enable_factory_create):
        ...
        value = get_soap_operation_dict(request_xml, "GetApplicationListExpandedRequest")
        get_application_list_expanded_request_schema = schemas.GetApplicationListExpandedRequest(
            **value
        )
        result = get_application_list_expanded_response(
            db_session, get_application_list_expanded_request_schema
        )
        soap_envelope_dict = result.to_soap_envelope_dict("GetApplicationListExpandedResponse")
        expected = {
            "Envelope": {
                "Body": {
    ...
    def test_get_application_list_expanded_response_no_filter(
        ...
        value = get_soap_operation_dict(request_xml, "GetApplicationListExpandedRequest")
        get_application_list_expanded_rquest_schema = schemas.GetApplicationListExpandedRequest(
            **value
        )
        result = get_application_list_expanded_response(
            db_session, get_application_list_expanded_rquest_schema
        )
        soap_envelope_dict = result.to_soap_envelope_dict("GetApplicationListExpandedResponse")
        expected_1 = {
    ...
    def test_get_application_list_expanded_response_filters_successfully(
        self, db_session, enable_factory_create
    ):
        submission = ApplicationSubmissionFactory.create()
        application = submission.application
