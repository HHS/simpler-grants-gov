...
X = {
    ...
    "allOf": [
        # If ApplicationType is Revision, RevisionType is required
        {
            "if": {
                "properties": {
                    "ApplicationType": {"const": "Revision"}
                }
            },
            "then": {
        ...
        # If RevisionType is E, RevisionOtherSpecify becomes required
        {
            "if": {
                "properties": {
                    "RevisionType": {"const": "E: Other (specify)"}
                }
            },
            "then": {
                "required": ["RevisionOtherSpecify"]
            }
        }
    ],
    ...
    "properties": {
        ...
        "RevisionType": {
            ...
            "enum": ["A: Increase Award", "B: Decrease Award", "C: Increase Duration", "D: Decrease Duration", "E: Other (specify)", "AC: Increase Award, Increase Duration", "AD: Increase Award, Decrease Duration", "BC: Decrease Award, Increase Duration", "BD: Decrease Award, Decrease Duration"]
        },
