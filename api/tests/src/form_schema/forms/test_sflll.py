...
def test_sflll_v2_0_minimal_valid_json(minimal_valid_sflll_v2_0, sflll_v2_0):
    validation_issues = validate_json_schema_for_form(minimal_valid_sflll_v2_0, sflll_v2_0)
    assert len(validation_issues) == 0


def test_sflll_v2_0_full_valid_json(full_valid_sflll_v2_0, sflll_v2_0):
    validation_issues = validate_json_schema_for_form(full_valid_sflll_v2_0, sflll_v2_0)
    assert len(validation_issues) == 0


def test_sflll_v2_0_empty_json(sflll_v2_0):
    ...
    validate_required({}, EXPECTED_REQUIRED_FIELDS, sflll_v2_0)


def test_sflll_2_0_missing_material_change_fields(minimal_valid_sflll_v2_0, sflll_v2_0):
    ...
    validate_required(data, EXPECTED_REQUIRED_FIELDS, sflll_v2_0)


@pytest.mark.parametrize("bad_year", ["999", "10000", "-1000", "1000.123"])
def test_sflll_2_0_material_change_year_bad(full_valid_sflll_v2_0, bad_year, sflll_v2_0):
...
def test_sflll_2_0_empty_objects(minimal_valid_sflll_v2_0, sflll_v2_0):
    data = minimal_valid_sflll_v2_0
...
def test_sflll_2_0_entity_type_subawardee_missing_fields(minimal_valid_sflll_v2_0, sflll_v2_0):
    data = minimal_valid_sflll_v2_0
...
def test_sflll_2_0_empty_reporting_entities(minimal_valid_sflll_v2_0, sflll_v2_0):
    data = minimal_valid_sflll_v2_0
...
def test_sflll_2_0_empty_reporting_entity_address(minimal_valid_sflll_v2_0, sflll_v2_0):
    data = minimal_valid_sflll_v2_0
    data["reporting_entity"]["applicant_reporting_entity"] = {
...
def test_sflll_2_0_empty_lobbying_registrant_fields(minimal_valid_sflll_v2_0, sflll_v2_0):
    data = minimal_valid_sflll_v2_0
...
def test_sflll_2_0_empty_individual_performing_service_fields(minimal_valid_sflll_v2_0, sflll_v2_0):
    data = minimal_valid_sflll_v2_0
...
def test_sflll_2_0_empty_signature_block_name_fields(minimal_valid_sflll_v2_0, sflll_v2_0):
    data = minimal_valid_sflll_v2_0
...
def test_sflll_2_0_invalid_enums(minimal_valid_sflll_v2_0, field, value, sflll_v2_0):
    data = minimal_valid_sflll_v2_0
    data[field] = value
