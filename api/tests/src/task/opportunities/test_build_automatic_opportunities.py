...
def test_build_automatic_opportunities(enable_factory_create, db_session, forms):
    ...
    assert task.metrics[task.Metrics.OPPORTUNITY_CREATED_COUNT] == 21
    ...
    assert task.metrics[task.Metrics.OPPORTUNITY_ALREADY_EXIST_COUNT] == 21
