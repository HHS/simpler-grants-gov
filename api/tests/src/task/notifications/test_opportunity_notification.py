    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                '<p style="padding-left:20px;"><strong>Categorization</p>'
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                '<p style="padding-left:20px;"><strong>Grantor contact information</p>'
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                '<p style="padding-left:20px;"><strong>Eligibility</p>'
