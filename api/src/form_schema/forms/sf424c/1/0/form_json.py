...
FORM_JSON_SCHEMA = {
    "type": "object",
    "required": ["personnel_federal_share", "equipment_federal_share"],
    "properties": {
        "budget_information": {
        ...
        "equipment_federal_share": {
            "type": "number",
            "title": "Equipment Federal Share",
            "minimum": 0,
        },
        "equipment_non_federal_share": {
            "type": "number",
            "title": "Equipment Non-Federal Share",
            "minimum": 0,
            "readOnly": True,
        },
    },
        ...
        "children": [
            {
                ...
                "children": {
                    "columns": [
                        ...
                        {
                            "columnHeader": "Costs Not Allowable",
                            "width": 20,
                        },
                        {
