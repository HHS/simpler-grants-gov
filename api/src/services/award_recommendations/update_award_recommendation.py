...
def update_award_recommendation(
    ...
    award_recommendation.selection_method_detail = update_data.get("selection_method_detail")
    award_recommendation.funding_strategy = update_data.get("funding_strategy")
