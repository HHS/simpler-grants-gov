...
Revision ID: 1e7232cecfdb
Revises: a55bfb7b1bc0
Create Date: 2026-02-25 14:57:45.219488
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("workflow_entity_workflow_id_workflow_fkey"),
        ),
        sa.PrimaryKeyConstraint("workflow_entity_id", name=op.f("workflow_entity_pkey")),
        sa.UniqueConstraint("workflow_id", name=op.f("workflow_entity_workflow_id_uniq")),
        schema="api",
    )
