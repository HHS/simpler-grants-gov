...
Revision ID: 3f8a2f91ac7a
Revises: c111aac0ed6c
Create Date: 2024-02-23 14:36:58.020492
...
revision = "3f8a2f91ac7a"
down_revision = "c111aac0ed6c"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("estimated_posting_date", sa.Date(), nullable=True),
        sa.Column("estimated_response_date", sa.Date(), nullable=True),
        sa.Column("estimated_response_date_description", sa.Text(), nullable=True),
        ...
        sa.Column("is_legacy_forecast", sa.Boolean(), nullable=True),
        sa.Column("legacy_version_number", sa.Integer(), nullable=True),
