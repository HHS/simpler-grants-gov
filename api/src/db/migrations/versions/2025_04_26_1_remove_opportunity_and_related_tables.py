...
Revision ID: 5b5bf313f879
Revises: 3b0705202c54
Create Date: 2025-04-26 17:06:15.174016
...
def upgrade():
    ...
    op.drop_index("competition_form_family_id_idx", table_name="competition", schema="api")
...
def downgrade():
    ...
    op.create_index(
        "competition_form_family_id_idx",
        "competition",
        ["form_family_id"],
        unique=False,
        schema="api",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["competition_id"],
            ["api.competition.competition_id"],
            name="link_competition_open_to_applicant_competition_id_compe_e8fc",
        ),
        sa.ForeignKeyConstraint(
            ["competition_open_to_applicant_id"],
            ["api.lk_competition_open_to_applicant.competition_open_to_applicant_id"],
            name="link_competition_open_to_applicant_competition_open_to__7a3d",
        ),
        sa.PrimaryKeyConstraint(
            "competition_id",
            "competition_open_to_applicant_id",
            name="link_competition_open_to_applicant_pkey",
        ),
        schema="api",
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column(
            "last_notified_at",
            postgresql.TIMESTAMP(timezone=True),
            server_default=sa.text("'2025-04-26 16:53:58.920362+00'::timestamp with time zone"),
            autoincrement=False,
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
