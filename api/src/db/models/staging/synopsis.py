...
class TapplicanttypesSynopsis(StagingBase, synopsis_mixin.TapplicanttypesSynopsisMixin, StagingParamMixin):
    __tablename__ = "tapplicanttypes_synopsis"

class TapplicanttypesSynopsisHist(StagingBase, synopsis_mixin.TapplicanttypesSynopsisHistMixin, StagingParamMixin):
...
class TfundactcatSynopsisHist(StagingBase, synopsis_mixin.TfundactcatSynopsisHistMixin, StagingParamMixin):
...
class TfundinstrSynopsisHist(StagingBase, synopsis_mixin.TfundinstrSynopsisHistMixin, StagingParamMixin):
