...
class TapplicanttypesForecast(StagingBase, forecast_mixin.TapplicanttypesForecastMixin, StagingParamMixin):
    __tablename__ = "tapplicanttypes_forecast"



class TapplicanttypesForecastHist(StagingBase, forecast_mixin.TapplicanttypesForecastHistMixin, StagingParamMixin):
...
class TfundactcatForecastHist(StagingBase, forecast_mixin.TfundactcatForecastHistMixin, StagingParamMixin):
...
class TfundinstrForecastHist(StagingBase, forecast_mixin.TfundinstrForecastHistMixin, StagingParamMixin):
