...
from src.db.models.opportunity_models import CurrentOpportunitySummary, Opportunity, ExcludedOpportunityReview
        ...
        return (
            self.db_session.execute(
                ...
                .where(
                    ...
                    ~exists(
                        select(ExcludedOpportunityReview.opportunity_id)
                        .where(ExcludedOpportunityReview.opportunity_id == Opportunity.opportunity_id)
                    )
                )
