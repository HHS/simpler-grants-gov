...
class EmailNotificationConfig(PydanticBaseEnvConfig):
    ...
    enable_closing_date_notifications: bool = Field(default=True, alias="ENABLE_CLOSING_DATE_NOTIFICATIONS")
    enable_opportunity_notifications: bool = Field(default= True,alias="ENABLE_OPPORTUNITY_NOTIFICATIONS")
