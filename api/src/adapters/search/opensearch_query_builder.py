...
class SearchQueryBuilder:
    ...
    def track_scores(self, track_scores: bool) -> typing.Self:
        """
        Whether score values should be included in hits.
        """
    ...
    def filter_should_prefix(self, field: str, value: list[str]) -> typing.Self:
        ...
        This is used to match documents where the field value starts with the given prefix.
    ...
    def build(self) -> dict:
        ...
        request: dict[str, typing.Any] = {
            "size": page_size,
            "from": page_offset,
            "track_scores": self._track_scores,
