...
* Bounties are available on issues identified by the Simpler Grants team as being ready for community contributions
* Bounties are size medium (several hours' work) or larger issues
* Quality expectations for pull requests on bounty issues are high, including the documentation of the pull request. Please follow carefully the standards of PR documentation above.
* While it's fine to use AI tools to work on issues, bounty issues are of a size and complexity that make it unlikely you'll be able to collect a bounty on a PR wholly generated by AI tools.

> :information_source: The paid contributor program was initiated in mid-2026 and refinements to the process are ongoing. Many of the review steps are still currently manual and we appreciate your patience as we review your contributions.

To get started, [see a list of all open bounties.](https://github.com/HHS/simpler-grants-gov/issues?q=state%3Aopen%20label%3A%22status%3A%20open%20bounty%22)
