// // ============================================================================
// // Function to verify UI elements of the SF-LLL form using Playwright
// // This utility function navigates to the SF-LLL form and verifies the presence
// // of key UI elements such as section titles, field labels, and descriptions.
// // It captures detailed test information and attaches it to the test report.
// //
// // File: frontend/tests/e2e/utils/forms/user-interface-sflll-form-utils.ts
// // ============================================================================//
// //Usage:
// // import { userinterfaceSflllFormUtils } from "../utils/forms/user-interface-sflll-form-utils";
...
//         materialChangeYearDesc: "If this is a follow up report caused by a material change to the information previously reported, enter the year in which the change occurred.",
//         materialChangeQuarter: "Material Change Quarter",
//         materialChangeQuarterDesc: "If this is a follow up report caused by a material change to the information previously reported, enter the quarter in which the change occurred.",
//         lastReportDate: "Material Change Date of Last Report",
//         lastReportDateDesc: "Enter the date of the previously submitted report by this reporting entity for this covered Federal action.",
//     },
//     reportingEntity: {
//         title: "4. Name and Address of Reporting Entity",
//         entityType: "Entity Type*",
//         entityTypeDesc: "Check the appropriate classification of the reporting entity that designates if it is, or expects to be, a prime subaward recipient.",
//         entityTypeOptions: "- Select -PrimeSubAwardee",
//         tier: "Reporting Entity Tier",
//         tierDesc: "Identify the tier of the subawardee, e.g., the first subawardee of the prime is the 1st tier.",
...
//         districtDesc: "Enter the Congressional District in the format: 2 character state Abbreviation - 3 character District Number. Examples: CA-005 for California's 5th district, CA-012 for California's 12th district.",
//     },
//     primeReportingEntity: {
//         title: "5. If Reporting Entity in No. 4 is Subawardee, Enter Name and Address of Prime",
//         orgName: "Organization Name",
//         street1: "Street 1",
//         street1Desc: "Enter the first line of the Street Address.",
//         street2: "Street 2",
...
//         assistanceNumberDesc: "If known, the full Assistance Listing Number for grants, cooperative agreements, loans and loan commitments.",
//     },
//     federalActionNumber: {
...
//     },
//     {
//         locator: '#label-for-reporting_entity--applicant_reporting_entity--organization_name',
...
//     },
//     {
//         locator: '#label-for-reporting_entity--prime_reporting_entity--organization_name',
...
//         await testInfo.attach("userInterfaceSflllFormUtils-applicationURL", {
...
//         await expect(page.getByText(ENTITY_DATA.form.name)).toBeVisible({ timeout: 35000 });
...
//         throw error;
//     } finally {
//         // Attach a summary of the test execution
