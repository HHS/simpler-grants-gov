  ...
  [
    {
      ...
      inlineErrorSelector: "#error-for-contact_name",
    },
    {
      label: "Title",
      type: "text",
    ...
    },
    {
      ...
      inlineErrorSelector: "#error-for-contact_email",
    },
    {
      label: "Phone number",
      type: "text",
      ...
      inlineErrorSelector: "#error-for-contact_phone",
    },
  ];
