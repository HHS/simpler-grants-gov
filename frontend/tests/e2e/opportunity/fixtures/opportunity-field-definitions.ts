...
export const opportunityFieldDefinitions: Record<
  string,
  OpportunityFieldDefinition
> = {
  opportunityNumber: {
  ...
  expectedAwards: {
    ...
    type: "text",
    field: "Expected number of awards",
  },
  totalProgram: {
    label: "Estimated total program funding",
    type: "text",
    field: "Estimated total program",
  },
  awardMinimum: {
    label: "Award minimum",
    type: "text",
  ...
  closeDateExplanation: {
    selector: "#close-date-explanation",
    type: "text",
    field: "Close date explanation",
  },
  description: { label: "Description", type: "text", field: "Description" },
  additionalInfoLink: {
    label: "Link to additional information",
    type: "text",
    field: "Link to additional information",
  },
  additionalInfoText: {
    label: "Link display text",
    type: "text",
    field: "Link display text",
  },
  grantorContact: {
    label: "Grantor contact details",
    type: "text",
    field: "Grantor contact details",
  },
  contactEmail: {
    label: "Contact email",
    type: "text",
  ...
  emailDisplayText: {
    ...
    type: "text",
    field: "Email display text",
  },
  eligibleApplicantSmallBusinesses: {
    getByText: "Small businesses",
    textExact: true,
    type: "checkbox",
    field: "Small businesses",
  },
  eligibleApplicantOtherNativeAmericanTribal: {
    getByText: "Other Native American tribal",
    type: "checkbox",
    field: "Other Native American tribal",
  },
  eligibleApplicantIndependentSchoolDistricts: {
    getByText: "Independent school districts",
    type: "checkbox",
    field: "Independent school districts",
  },
  ...
  eligibleApplicantStateGovernments: {
    getByText: "State governments",
    type: "checkbox",
    field: "State governments",
  },
};
