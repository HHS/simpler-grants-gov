...
import { EPA_KEY_CONTACTS_FORM_CONFIG } from "./fixtures/epa-key-contacts-field-definitions";
import { epaKeyContactsHappyPathTestData } from "./fixtures/epa-key-contacts-fill-data";
...
test(
  "Application form completion happy path - EPA Key Contacts",
  ...
  async (
    ...
    await fillForm(
      testInfo,
      page,
      EPA_KEY_CONTACTS_FORM_CONFIG,
      epaKeyContactsHappyPathTestData,
      false,
    );
