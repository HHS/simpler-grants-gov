...
import { SF424D_FORM_CONFIG } from "tests/e2e/apply/fixtures/sf424d-field-definitions";
import { sf424DHappyPathTestData } from "tests/e2e/apply/fixtures/sf424d-fill-data";
...
test(
  "Application form completion happy path - SF424D",
