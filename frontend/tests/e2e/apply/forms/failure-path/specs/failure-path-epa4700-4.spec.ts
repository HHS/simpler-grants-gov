...
test(
  ...
  async (
    ...
    // And the Application landing page loads with the "EPA Form 4700-4" form link visible
    ...
    // Then under the "EPA Form 4700-4" form the status shows "Some issues found. Check your entries."
