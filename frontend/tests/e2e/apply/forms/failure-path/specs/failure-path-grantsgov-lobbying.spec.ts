...
test(
  ...
  async (
    ...
    // And the Application landing page loads with the "Grants.gov Lobbying" form link visible
    ...
    // Then under the "Grants.gov Lobbying" form the status shows "Some issues found. Check your entries."
