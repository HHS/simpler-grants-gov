 ...
 * @scenario Application form completion failure path - cd511
 */
...
test(
  ...
  async (
    ...
    // And the Application landing page loads with the "CD511" form link visible
    ...
    // Then under the "CD511" form the status shows "Some issues found. Check your entries."
