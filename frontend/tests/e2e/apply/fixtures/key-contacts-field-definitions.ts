...
// Fills only the first Key Contact entry (index 0). key_contacts has
// minItems: 1, maxItems: 4 - filling one instance satisfies the required
// minimum, matching the PPSL precedent of filling only the primary/first
// instance of a repeatable group and skipping the rest.
//
