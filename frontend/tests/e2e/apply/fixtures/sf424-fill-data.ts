export const sf424HappyPathTestData = {
  ...
  areas_affected_attachment: "tests/e2e/files-upload-for-test/Test-data.docx",
  project_title: "Project Title test data",
  additional_project_title_attachment:
    "tests/e2e/files-upload-for-test/Test-data.docx",
  ...
  debt_explanation_attachment: "tests/e2e/files-upload-for-test/Test-data.docx",
