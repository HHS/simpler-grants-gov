...
export const SAMPLE_UPLOAD_FILE_ZIP_3543KB = path.join(
  TEST_UPLOAD_DIR,
  SAMPLE_UPLOAD_FILE_NAME_ZIP_3543KB,
);
export const SAMPLE_UPLOAD_FILE_PATH_ZIP_3543KB = SAMPLE_UPLOAD_FILE_ZIP_3543KB;
export const SAMPLE_UPLOAD_FILE_NAME_MSWORD_0KB = "TestMSword0Kb.docx";
export const SAMPLE_UPLOAD_FILE_MSWORD_0KB = path.join(
  TEST_UPLOAD_DIR,
  SAMPLE_UPLOAD_FILE_NAME_MSWORD_0KB,
);
export const SAMPLE_UPLOAD_FILE_PATH_MSWORD_0KB = SAMPLE_UPLOAD_FILE_MSWORD_0KB;
