 ...
 * @scenario Application form completion happy path - Supplementary Cover Sheet for NEH Grant Programs
 */
...
test(
  "Application form completion happy path - Supplementary Cover Sheet for NEH Grant Programs",
  ...
  async (
    ...
    await fillForm(
      ...
      suppCoverSheetNEHHappyPathTestData,
      false,
    );
