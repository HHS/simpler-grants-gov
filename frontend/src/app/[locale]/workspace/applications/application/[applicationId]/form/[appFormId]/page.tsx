...
import { AttachmentContext } from "src/components/applyForm/AttachmentContext";
...
async function FormPage({ params }: formPageProps) {
  ...
  let applicationAttachments: Attachment[] = []; // ✅ Moved here
  ...
  try {
    ...
    applicationAttachments = applicationData.application_attachments ?? []; // ✅ Now valid
