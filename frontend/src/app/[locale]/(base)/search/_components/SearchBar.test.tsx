...
import SearchBar from "src/app/[locale]/(base)/search/_components/SearchBar";
import { SearchLabel } from "src/app/[locale]/(base)/search/_components/SearchBarWithLabel";
import {
  FakeQueryProvider,
  mockUpdateQueryTerm,
