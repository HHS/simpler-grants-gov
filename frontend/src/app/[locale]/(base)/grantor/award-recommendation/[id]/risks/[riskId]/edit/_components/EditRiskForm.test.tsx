...
import { updateRiskAction } from "src/app/[locale]/(base)/grantor/award-recommendation/[id]/risks/actions";
...
jest.mock(
  "src/app/[locale]/(base)/grantor/award-recommendation/[id]/risks/actions",
  () => ({
