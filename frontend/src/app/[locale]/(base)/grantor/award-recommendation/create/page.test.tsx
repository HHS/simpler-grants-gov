...
import CreateAwardRecommendationPage, {
  generateMetadata,
} from "src/app/[locale]/(base)/grantor/award-recommendation/create/page";
...
jest.mock(
  "src/app/[locale]/(base)/grantor/award-recommendation/create/_components/CreateRecommendationContent",
  () => ({
