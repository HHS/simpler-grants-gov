...
import SelectOpportunityPage, {
  generateMetadata,
} from "src/app/[locale]/(base)/grantor/award-recommendation/select-opportunity/page";
...
jest.mock(
  "src/app/[locale]/(base)/grantor/award-recommendation/select-opportunity/_components/SelectFundingOpportunityContent",
  () => ({
