...
import { createAwardRecommendationAction } from "src/app/[locale]/(base)/grantor/award-recommendation/select-opportunity/actions";
...
jest.mock(
  "src/app/[locale]/(base)/grantor/award-recommendation/select-opportunity/actions",
  () => ({
