...
import AwardRecommendationsListPage, {
  generateMetadata,
} from "src/app/[locale]/(base)/grantor/award-recommendation/page";
...
jest.mock(
  "src/app/[locale]/(base)/grantor/award-recommendation/_components/AwardRecommendationsListContent",
  () => ({
    __esModule: true,
