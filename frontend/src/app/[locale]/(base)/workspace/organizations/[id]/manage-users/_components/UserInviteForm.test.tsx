...
import { UserInviteForm } from "src/app/[locale]/(base)/workspace/organizations/[id]/manage-users/_components/UserInviteForm";
...
jest.mock(
  "src/app/[locale]/(base)/workspace/organizations/[id]/manage-users/actions",
  () => ({
