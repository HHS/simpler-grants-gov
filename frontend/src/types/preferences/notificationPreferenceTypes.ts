...
export interface SavedOpportunityNotificationPreferencesApiResponse extends Omit<
  APIResponse,
  "data"
> {
...
export interface UpdateSavedOpportunityNotificationPreferenceBody extends Record<
  string,
  unknown
> {
...
export interface UpdateSavedOpportunityNotificationPreferenceApiResponse extends Omit<
  APIResponse,
  "data"
> {
  data: null;
