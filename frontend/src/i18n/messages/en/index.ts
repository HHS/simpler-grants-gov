          ...
          [
            {
              ...
              content:
                "<p>We will create a comprehensive service blueprint showing how the existing Grants.gov application process could be simplified. Then, we'll prototype an application form with persistent data storage and scope a pilot for a small subset of opportunities.</p><p><linkGithub3348>Follow #3348 on GitHub</linkGithub3348></p>",
            },
            {
              title:
                "Full support for opportunity page attachments (NOFOs/downloads)",
              content:
                "<p>The opportunity listings on Simpler.Grants.gov will include all information and file attachments available on Grants.gov. Design updates will make the Notice of Funding Opportunity (NOFO) easier to access.</p><p><linkGithub3045>Follow #3045 on GitHub</linkGithub3045></p>",
            },
          ],
          [
            {
              ...
              content:
                "<p>Enable grant seekers to create an account on Simpler.Grants.gov using the Login.gov single sign-on platform to minimize the steps and friction users experience when signing up.</p><p><linkGithub2640>Follow #2640 on GitHub</linkGithub2640></p>",
            },
            {
              title: "Search & opportunity page improvements",
              content:
                "<p>With feedback from the community, we will iterate on improvements that make it easier to adjust search filter criteria, share search results, and save relevant results and opportunities.</p><p><linkGithub2875>Follow #2875 on GitHub</linkGithub2875></p>",
            },
          ],
        ],
