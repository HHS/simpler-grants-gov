export const messages = {
  ...
  Process: {
    ...
    involved: {
      ...
      paragraph_1: "We're spending time up-front collaborating with stakeholders on API design and data standards. If you have subject matter expertise with grants data, we want to talk. Contact us at <strong><email>simpler@grants.gov</email></strong>.",
      title_2: "Are you code-savvy?",
      paragraph_2: "If you’re interested in contributing to the open-source project or exploring the details of exactly what we’re building, check out the project at <strong><github>https://github.com/HHS/simpler-grants-gov</github></strong> or join our community at <strong><wiki>wiki.simpler.hhs.gov</wiki></strong>."
    }
  },
  Newsletter: {
    ...
    errors: {
      ...
      already_subscribed: "{{email_address}} is already subscribed. If you’re not seeing our emails, check your spam folder and add no-reply@grants.gov to your contacts, address book, or safe senders list. If you continue to not receive our emails, contact <email>simpler@grants.gov</email>.",
      sendy: "Sorry, an unexpected error in our system occured when trying to save your subscription. If this continues to happen, you may email <email>simpler@grants.gov</email>. Error: {{sendy_error}}"
    }
  },
