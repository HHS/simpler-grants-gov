          ...
          <Grid row gap>
            ...
            >
              ...
              <ul className="margin-top-0 font-sans-md line-height-sans-4 desktop-lg:line-height-sans-6">
                <li>
                  <a href={t("get_involved_a_1")}>{t("get_involved_li_1")}</a>
                </li>
                <li>
                  <a href={t("get_involved_a_2")}>{t("get_involved_li_2")}</a>
                </li>
                <li>
                  <a href={t("get_involved_a_3")}>{t("get_involved_li_3")}</a>
                </li>
                <li>
                  <a href={t("get_involved_a_4")}>{t("get_involved_li_4")}</a>
                </li>
                <li>
                  <a href={t("get_involved_a_5")}>{t("get_involved_li_5")}</a>
                </li>
              </ul>
            </Grid>
          </Grid>
