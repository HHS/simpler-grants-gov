  ...
  return (
    <GridContainer>
      ...
      <p className="tablet-lg:font-sans-lg line-height-sans-3 usa-intro margin-top-2">
        We’re incrementally improving this experimental search page. How can we
        make it easier to discover grants that are right for you? Let us know at{" "}
        <a href="mailto:simpler@grants.gov">simpler@grants.gov</a>.
      </p>
    </GridContainer>
  );
};
