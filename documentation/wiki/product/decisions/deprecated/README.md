...
This directory contains Architecture Decision Records (ADRs) that have been superseded or are no longer applicable.

## Purpose

Deprecated ADRs are retained for historical reference and to understand the evolution of architectural decisions within the project.
