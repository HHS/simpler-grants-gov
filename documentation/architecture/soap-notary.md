...
🚨🚨🚨 NOTE: Ability for existing S2S consumers to be able to hit the SOAP Notary is still under development and is expected to be ready for actual test usage in Spring 2026.

Switching to the SOAP Notary is as simple as changing the URL portion of the SOAP endpoint your system is calling. Switching to the SOAP Notary will expose, in XML fully compatible with the existing SOAP schemas, Applications from both the existing Grants.gov SOAP API and Simpler Grants.gov. Nothing in the integrating system should need to change to facilitate this new functionality.

It is highly recommended you switch over in a lower environment first to discover and issues/quirks in a non-Production environment.

| Environment | Audience  | Existing S2S URL                                                                          | SOAP Notary URL                                                                                      |
| ----------- | --------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Prod        | Grantor   | https://ws07.grants.gov/grantsws-agency/services/v2/AgencyWebServicesSoapPort             | https://soap.simpler.grants.gov/grantsws-agency/services/v2/AgencyWebServicesSoapPort                |
| Training    | Grantor   | https://trainingws.grants.gov/grantsws-agency/services/v2/AgencyWebServicesSoapPort       | https://soap.training.simpler.grants.gov/grantsws-agency/services/v2/AgencyWebServicesSoapPort       |
| Prod        | Applicant | https://ws07.grants.gov/grantsws-applicant/services/v2/ApplicantWebServicesSoapPort       | https://soap.simpler.grants.gov/grantsws-applicant/services/v2/ApplicantWebServicesSoapPort          |
| Training    | Applicant | https://trainingws.grants.gov/grantsws-applicant/services/v2/ApplicantWebServicesSoapPort | https://soap.training.simpler.grants.gov/grantsws-applicant/services/v2/ApplicantWebServicesSoapPort |
