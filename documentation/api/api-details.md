...
To keep our response schema following a consistent pattern, we have a few base schema classes like [AbstractResponseSchema](https://github.com/HHS/grants-shared/blob/main/backend/grants_shared/src/grants_shared/api/schemas/response_schema.py)
