...
The [LookupRegistry](https://github.com/HHS/grants-shared/blob/main/backend/grants_shared/src/grants_shared/db/models/lookup/lookup_registry.py) is a global registry that defines the table for each lookup value. This is used in two ways:
