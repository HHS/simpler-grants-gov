...
This document describes how logging is configured in the application. The logging functionality is defined in the [src.logs](../../../api/src/logs) package and leverages Python's built-in [logging](https://docs.python.org/3/library/logging.html) framework.
...
of what you configure in the [flask_logger](../../../api/src/logs/flask_logger.py). This includes:
* Request ID
...
The [src.logs.pii](../../../api/src/logs/pii.py) module defines a filter that applies to all logs that automatically masks data fields that look like social security numbers.

## Audit Logging

We have configured [audit logging](../../../api/src/logs/audit.py) which logs
