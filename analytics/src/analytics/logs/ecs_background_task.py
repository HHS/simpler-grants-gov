"""Utility methods for automatically logging information about an ECS task."""
...
def _ecs_background_task_impl(task_name: str, scheduled_job_name: str | None = None) -> Generator[None, None, None]:
