...
class TestRequiredImplementations:
    ...
    def test_raise_not_implemented_on_init_due_to_calculate(self):
        """Error should be raised for __init__() method without calculate()."""
        with pytest.raises(NotImplementedError):
            BaseMetric()

    def test_raise_not_implemented_on_init_due_to_get_stats(self):
        """Error should be raised for __init__() method without get_stats()."""
        with pytest.raises(NotImplementedError):
            MetricWithoutStats()

    def test_raise_not_implemented_for_plot_results(self):
        """NotImplementedError should be raised for plot_results()."""
        mock_metric = MetricWithoutPlotResults()
        with pytest.raises(NotImplementedError):
            mock_metric.plot_results()

    def test_raise_not_implemented_for_format_slack_message(self):
