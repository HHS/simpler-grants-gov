...
def mock_collections():
    ...
    return [
        {"id": 1, "name": "Collection 1", "location": "/1"},
        {"id": 2, "name": "Collection 2", "location": "/1/2"},
        {"id": 3, "name": "Collection 3", "location": ""},  # Root level collection
        {"id": 4, "name": "Collection 4", "location": "/1/2/4"},
        {"id": 5, "name": "Collection 5", "location": "/invalid/5"},  # Invalid parent
    ]
...
def test_backup_process(backup, mock_collections, mock_items, mock_query, tmp_path):
    ...
    collection_path = tmp_path / "1-Collection_1" / "1-Collection_1"
