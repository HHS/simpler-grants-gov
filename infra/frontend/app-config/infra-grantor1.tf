# frontend service for the infra-grantor1 environment (AWS account 315341936575, network_name "infra-grantor1").
...
module "infra_grantor1_config" {
  ...
  domain_name                     = null # "infra-grantor1.simpler.grants.gov" once DNS + certs exist
  enable_https                    = false
