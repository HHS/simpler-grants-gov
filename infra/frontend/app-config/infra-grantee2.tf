# frontend service for the infra-grantee2 environment (AWS account 315341936575, network_name "infra-grantee2").
...
module "infra_grantee2_config" {
  ...
  domain_name                     = null # "infra-grantee2.simpler.grants.gov" once DNS + certs exist
  enable_https                    = false
