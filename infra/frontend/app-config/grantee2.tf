module "grantee2_config" {
  ...
  service_newrelic_entity_guid      = "NTI0OTgwOXxJTkZSQXxOQXw4MzgyMTcwOTA1MjIyODM3MDk2"
  service_host_newrelic_entity_guid = "NTI0OTgwOXxCUk9XU0VSfEFQUExJQ0FUSU9OfDExMjA1MjMyNDY"
