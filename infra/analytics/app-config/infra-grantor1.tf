# analytics service for the infra-grantor1 environment (AWS account 315341936575, network_name "infra-grantor1").
#
# infra-grantor1 mirrors the existing training environment's analytics service +
...
module "infra_grantor1_config" {
  ...
  database_newrelic_entity_guid = ""     # Populate once the New Relic entity for the infra-grantor1 analytics RDS cluster exists
