...
module "aws_vpc" {
  ...
  public_subnets             = ["10.${var.second_octet}.10.0/24", "10.${var.second_octet}.11.0/24", "10.${var.second_octet}.12.0/24", "10.${var.second_octet}.13.0/24"]
  private_subnets            = ["10.${var.second_octet}.0.0/24", "10.${var.second_octet}.1.0/24", "10.${var.second_octet}.2.0/24", "10.${var.second_octet}.14.0/24"]
