...
resource "aws_dms_endpoint" "source_endpoint" {
  ...
  extra_connection_attributes     = "useLogminerReader=N;useBfile=Y;replacePathPrefix=true;usePathPrefix=/rdsdbdata/db/TSTGRNTS_A/;useAlternateFolderForOnline=true;oraclePathPrefix=/rdsdbdata/db/TSTGRNTS_A/;accessAlternateDirectly=false"
}
