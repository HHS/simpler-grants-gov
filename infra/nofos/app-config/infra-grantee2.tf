# nofos service for the infra-grantee2 environment (AWS account 315341936575, network_name "infra-grantee2").
...
module "infra_grantee2_config" {
  ...
  database_newrelic_entity_guid = ""     # Populate once the New Relic entity for the infra-grantee2 nofos RDS cluster exists
