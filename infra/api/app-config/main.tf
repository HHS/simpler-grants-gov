locals {
  ...
  environments = ["dev", "staging", "prod", "training", "grantee1", "grantee2", "grantor1", "infra-dev", "infra-staging", "infra-training", "infra-grantee2"]
  ...
  account_names_by_environment = {
    ...
    infra-grantee2 = "simpler-grants-gov" # reuses the main simpler-grants-gov account (315341936575) with its own VPC
