locals {
  ...
  environments = ["dev", "staging", "prod", "training", "grantee1", "grantee2", "sgg1", "infra-dev", "infra-staging", "infra-training", "infra-grantee1", "infra-grantee2", "infra-sgg1"]
  ...
  environment_configs = {
    ...
    # account's grantee1/grantee2/sgg1. They deploy only api + frontend.
