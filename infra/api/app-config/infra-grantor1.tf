# api service for the infra-grantor1 environment (AWS account 315341936575, network_name "infra-grantor1").
...
module "infra_grantor1_config" {
  ...
  service_override_extra_environment_variables = {
    ...
    # Workflow. This is training's internal user id, reused because infra-grantor1's database
