...
#
# infra-sgg1 is a team environment in the "dev" account. It replaced infra-grantor1, which
# was torn down rather than renamed: a rename replaces the DB subnet group, the ECS services
# and every bucket anyway, and the account was at its 5-VPC quota. Settings that are
...
#   - New Relic entity GUIDs: create the infra-sgg1 entities, then fill these in.
...
module "infra_sgg1_config" {
  ...
  # Sizing carried over from infra-grantor1.
