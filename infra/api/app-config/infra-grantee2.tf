# api service for the infra-grantee2 environment (AWS account 315341936575, network_name "infra-grantee2").
...
module "infra_grantee2_config" {
  ...
  service_override_extra_environment_variables = {
    ...
    # Workflow. This is training's internal user id, reused because infra-grantee2's database
