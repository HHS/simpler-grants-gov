...
module "service" {
  ...
  instance_scaling_max_capacity = local.service_config.instance_scaling_max_capacity
  instance_scaling_min_capacity = local.service_config.instance_scaling_min_capacity
  cpu                           = 1024
  memory                        = 2048
