...
- When setting up production, [repeat the account setup steps for the production account](/documentation/infra/set-up-aws-account.md)

---

- Every environment has its own AWS account
- When setting up staging and production, [repeat the account setup steps for each environment](/documentation/infra/set-up-aws-account.md)
...
- When setting up production, [repeat the VPC setup steps for the production account](/documentation/infra/set-up-network.md)

---

- Each environment gets its own VPC
- When setting up staging and production, [repeat the VPC setup steps for each environment](/documentation/infra/set-up-network.md)
...
- [Repeat the application database](/documentation/infra/set-up-database.md) and [applcation environment setup steps](/documentation/infra/set-up-app-env.md) for each environment. Remember to update `staging.tf` and `prod.tf` to:
